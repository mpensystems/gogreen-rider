...
const OtpScreenDelivery = () => {
  ...
  const handleSetStatus = async otp => {
    ...
    console.log(data, 'SET_STATUS_RESPONSE_PICKUP_VERIFY');
    ...
    try {
      ...
      setLoading(false);
      console.error('Error in OTP_DELIVERY:', error.message);
      setIsModalVisible(true);
...
export default OtpScreenDelivery;
